...
class NativeAdsClient : public ads::AdsClient {
 ...
 private:
  ...
  void GetCreativePublisherAdsToPreCache(ads::OnGetCreativePublisherAdsToPreCacheCallback callback) override;
  void FlagPublisherAdWasPreCached(const std::string & creative_instance_id, ads::OnFlagPublisherAdWasPreCachedCallback callback) override;
  void SiteSupportsPublisherAds(const std::string & url, ads::OnSiteSupportsPublisherAdsCallback callback) override;
