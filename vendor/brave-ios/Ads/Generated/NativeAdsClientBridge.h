...
- (void)getCreativePublisherAdsToPreCache:(ads::OnGetCreativePublisherAdsToPreCacheCallback)callback;
- (void)flagPublisherAdWasPreCached:(const std::string &)creativeInstanceId callback:(ads::OnFlagPublisherAdWasPreCachedCallback)callback;
